...
<head>
    ...
    <body>
        ...
        <tr>
          <td>
          <!--  <P>
           <A HREF="<?php echo base_url()?>tecnica/ingresardettec">Agregar</A>
           </P>   -->
          ...
          $('#registrartecnica').click(function(e){
            ...
            $('#articulos div').each(function(){
              var aux = {
                ...
                'secuencial': $(this).find('').val(),
                'tb_articulo_tb_tipomedida_codigo_tipomedida' : $('select[name="medida"] option:selected').val()
               // 'tb_articulo_tb_categoria_cod_categoria' : $('select[name="medida"] option:selected').val()
                //'tb_articulo_tb_embalaje_codigo_embalaje' : $('select[name="medida"] option:selected').val()
