...
<body>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
   <form id="formparametro" action="http://localhost:81/LCAsys/code/index.php/metodo/guardar" method="post">

      <div class="modal-content">
      <div class="modal-header">
          
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">INGRESO METODOS</h4>
      ...
      <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-primary" id="guardarmetodo" >Guardar</button>
      </div>
    </div>
       </form>
